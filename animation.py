...
L = 2.3
timesteps = 1000
coords_file = './output/avs_T1000.dat' #file with xyz positions of atoms
data_file = './output/out_T1000.txt' #file with t. T, P, H data
numP = n*n*n
...
def animate(i):
    ...
    ax.scatter(x[idx0:idx1],y[idx0:idx1],z[idx0:idx1], c = 'm', s = 360, label = "T = " + str(T[i]) + "\nP = " + str(P[i]) + "\nt = " + str(t[i]))
    ax.legend()
